...
if DEPLOY == "PRODUCTION":
    MEDIA_ROOT = "/home/beren5000/webapps/usersjuicenotestat/media/"
...
STATIC_URL = '/static/'
STATIC_URL_ROOT = 'http://users.juicenote.com/security/'
...
SECRET_KEY = 'gav%^*g%993*f)cce0!e$r18^j)tl#wf8g8mr2mo$sc^@cn=x%'
